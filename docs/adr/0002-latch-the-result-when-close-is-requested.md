...
- `TickerCanceled` is still caught, but only inside the widget that owns the ticker, where it means "my ticker died". It no longer carries information across a seam.
